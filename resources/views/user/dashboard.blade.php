...
<div class="grid-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 lg:p-6 hover:shadow-md transition-shadow duration-300 relative overflow-hidden group flex flex-col justify-between">
        ...
        <div class="flex flex-wrap items-center gap-1.5 mt-2 relative z-10">
            ...
            <span class="text-gray-400 font-medium text-[0.65rem] lg:text-xs leading-tight">Mendekati deadline</span>
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="flex gap-2.5 flex-wrap">
        <a href="{{ url('user/events') }}" class="btn btn-primary text-sm">Lihat Kegiatan</a>
        <a href="{{ url('user/riset') }}" class="btn btn-outline border-blue-600 text-blue-700 bg-white text-sm">Baca Riset</a>
        <a href="{{ url('user/kamus') }}" class="btn btn-outline border-blue-600 text-blue-700 bg-white text-sm">Kamus Saham</a>
        <a href="{{ url('user/kalkulator') }}" class="btn btn-outline border-blue-600 text-blue-700 bg-white text-sm">Kalkulator Saham</a>
        <a href="{{ url('user/pengaturan') }}" class="btn btn-ghost border-gray-300 text-gray-600 bg-white text-sm">Pengaturan</a>
    </div>
</div>
...
<div style="margin-top:20px">
    <div class="section-header flex items-center justify-between mb-5 mt-2 gap-3 flex-wrap" style="margin-bottom:16px">
        <div>
            ...
            <div class="section-sub text-sm text-gray-500">Statistik pengunjung dan riwayat aktivitas terpadu</div>
        </div>
