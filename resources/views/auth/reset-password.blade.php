...
<head>
    ...
    <title>Reset Password - KSPM</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-extrabold text-gray-900 tracking-tight">Buat Password Baru</h1>
            <p class="text-sm text-gray-500 mt-1">Masukkan password baru yang kuat untuk akun Anda</p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-6 md:p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
            ...
            <form action="{{ route('user.reset-password.store') }}" method="POST" class="space-y-5">
                @csrf
